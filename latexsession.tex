...
\usepackage{listings} % Insert formatted source code
...
% If you omit \date{\today}, LaTeX assumes you meant today.
% You only need this if you want to specify a different date.
\date{\today}
...
\lstinputlisting[language=Python, caption=The Code, label=lst:fibonnaci]{fibonacci.py}
